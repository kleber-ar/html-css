...
const bestScore = (best, materia) => (best.nota > materia.nota) ? best : materia;

const theBest =  (students) => students.map((student) => ({
    nome: student.nome,
    sobrenome: student.sobrenome,
    turno: student.turno,
    materia: student.materias.reduce(bestScore),
}));

console.log(theBest(estudantes));