...
firstLi.addEventListener('click', addTransform);
secondLi.addEventListener('click', addTransform);
thirdLi.addEventListener('click', addTransform);
...
myWebpage.addEventListener('dblclick', () => {
  window.open('https://github.com/kleber-ar','_blank');
